...
@IBDesignable class GraphEEGView: UIView {
    var plotValues: [Double]!
    var xLabels: [String]!
    var count: Int!
    
    let startColor: UIColor = UIColor(red: 255.0/255.0, green: 188.0/255.0, blue:143.0/255.0, alpha: 1.0);
    let endColor: UIColor = UIColor(red: 255.0/255.0, green: 63.0/255.0, blue:21.0/255.0, alpha: 1.0);
    ...
    override func drawRect(rect: CGRect) {
        ...
        var columnYPoint = { (graphPoint:Double) -> CGFloat in
            var y:CGFloat = (CGFloat(graphPoint) - CGFloat(minValue)) /
                (CGFloat(maxValue) - CGFloat(minValue)) * graphHeight
